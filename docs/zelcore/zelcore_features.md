...
=== "API Trading"
    Connect to Exchanges with your API credentials and trade directly from ZelCore.
...
=== "Wallet Connect"
    Allows connection to Web3 apps such as UniSwap using WalletConnect protocol.
...
=== "CruxID"
    Human readable payment address for all your crypto assets.
